                    ...
                    <div class="questions-page-question-wrapper">
                        ...
                        <div class="questions-page-question-container">
                                ...
                                <div class="questions-page-question-choices">
                                    <?php foreach ($studentquestion->choices as $choice): ?>
                                        <div class="questions-page-question-choice-one">
                                            ...
                                            <label <?= checkQuestionSelected($choice) ?> for="choice-one"><?= $choice->choice ?></label>
                                        </div>
                                    <?php endforeach;  ?>
                            </div>
                            ...
                            <div class="form-group" style='color:blue ;font-weight: bold; font-size: 1.6rem;'>
                                    ...
                                    <input id ='mark1' required name="date" value="" type="number" class="form-control" placeholder="Mark" style="font-size: 1rem;">
                            </div>
                        </div>
                    </div>
                    <?php endforeach; ?>
