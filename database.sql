...
INSERT INTO `users` (`id`, `university_id`, `f_name`, `m_name`, `l_name`, `address`, `phone_number`, `username`, `password`, `email`, `photo`, `rank`, `created_by`, `date`) VALUES (NULL, NULL, 'mahmoud', 'mohammed', 'jaafar', 'palestine-gaza', '0598790035', 'admin2000', 'd033e22ae348aeb5660fc2140aec35850c4da997', 'admin@gmail.com', 'http://localhost\\model\\data\\users\\admin.jpg', 'admin', NULL, current_timestamp());
